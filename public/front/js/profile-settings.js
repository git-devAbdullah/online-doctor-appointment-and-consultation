...
(function($) {
    ...
    $(".reg-education-info").on('click','.trash', function () {
		$(this).closest('.reg-education-cont').remove();
		return false;
    });

    $(".reg-add-education").on('click', function () {

		var educationcontent = '<div class="row form-row reg-education-cont">'+
        '<div class="col-md-11">'+
            ...
            '</div>'+
        '</div>' +
			'<div class="col-md-1"><label class="d-md-block d-sm-none d-none">&nbsp;</label><a href="#" class="btn btn-danger trash"><i class="far fa-trash-alt"></i></a></div>' +
		'</div>';

        $(".reg-education-info").append(educationcontent);
        return false;
    });
    ...
    $(".reg-experience-info").on('click','.trash', function () {
		$(this).closest('.reg-experience-cont').remove();
		return false;
    });

    $(".reg-add-experience").on('click', function () {

		var experiencecontent = '<div class="row form-row reg-experience-cont">'+
        '<div class="col-md-11">'+
            '<div class="row form-row">'+
                '<div class="col-md-4">'+
                    '<div class="form-group">'+
        ...
        $(".reg-experience-info").append(experiencecontent);
        return false;
    });
